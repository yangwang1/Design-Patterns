...
public class InsuranceContract {
    ...
    public void someOperation() {
        ...
        System.out.println("----保险内容----");
        if(personName != null){
            System.out.println("投保人：" + personName);
        } else if (companyName != null) {
            System.out.println("投保公司：" + companyName);
        }

        System.out.println("生效日期：" + beginDate);
        System.out.println("失效日期：" + endDate);
